        ...
        <div className="navbar fixed z-50">
            ...
            >
                <div className="flex gap-4">
                    <a href="#welcome" className="btn btn-ghost text-base">{t('navbar.home')}</a>
                    <a href="#aboutme" className="btn btn-ghost">{ t("navbar.about")}</a>
                    <a href="#projects" className="btn btn-ghost">{t("navbar.projects")}</a>
                    <a href="#contact" className="btn btn-ghost">{t("navbar.contact")}</a>

                    <div className="dropdown">
                        <div tabIndex={0} role="button" className="btn btn-ghost">{ t("navbar.language")}</div>
